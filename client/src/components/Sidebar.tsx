            ...
            .map((message) => {
              ...
              if (isMessage) {
                ...
                return (
                  ...
                  >
                    {!isUser && (
                      <div className="w-8 h-8 rounded-full bg-linear-tobr from-indigo-600 to-indigo-700 flex items-center justify-center">
                    ...
                    <div className="flex items-center justify-between">
                      {project.current_version_index === ver.id ? (
                        ...
                        <button
                          ...
                          className="px-3 py-1 rounded-md text-xs bg-gray-500 hover:bg-indigo-600 text-white"
                        >
        ...
        <form onSubmit={handleRevisions} className="m-3 relative">
          <div className="flex items-center gap-2">
            <textarea
              ...
              className="flex flex-1 p-3 rounded-xl resize-none text-sm outline-none ring ring-gray-700 focus:ring-indigo-500 bg-gray-800 text-gray-100 placeholder-gray-400 transition-all"
